...
if e_1.Text='' then
  begin
    ...
    if e_3.text=''then
    begin
     ShowMessage('SUPPLIER ID BELUM DIISI DENGAN BENAR');
    end else
    if e_4.text=''then
    begin
    ...
    if e_5.text=''then
    begin
     ShowMessage('JUMLAH STOK BELUM SESUAI');
     end else
    if e_6.text=''then
    begin
     ShowMessage('TANGGAL MASUK BARANG BELUM SESUAI');
     end else
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into tbl_cek_stok values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'","'+e_6.Text+'")');
 zqry1.ExecSQL ;

 zqry1.SQL.Clear;
 zqry1.SQL.Add('select * from tbl_cek_stok');
 zqry1.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_cek_stok set barang_id="'+e_2.Text+'",supplier_id="'+e_3.Text+'",harga_beli="'+e_4.Text+'",jumlah_stok="'+e_5.Text+'",tanggal_masuk_barang="'+e_6.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_cek_stok where id="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_cek_stok');
zqry1.Open;
