...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('NAMA PT PELANGGAN BELUM DIISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
     ShowMessage('ALAMAT PT BELUM DIISI DENGAN BENAR');
    end else
    if e_4.text=''then
    begin
    ShowMessage('NAMA SUPPLIER BELUM SESUAI');
    end else
    if e_5.text=''then
    begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into tbl_supplier values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'","'+e_6.Text+'")');
 zqry1.ExecSQL ;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_supplier where id="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_supplier');
zqry1.Open;
